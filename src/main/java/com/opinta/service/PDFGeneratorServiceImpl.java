...
public class PDFGeneratorServiceImpl implements PDFGeneratorService {
    ...
    private static final String ERROR_WHILE_PARCING_PDF_TEMPLATE = "Error while parsing PDF template: ";
    ...
    public byte[] generatePostpay(long shipmentId) {
        ...
        try {
            ...
            log.error(ERROR_WHILE_PARCING_PDF_TEMPLATE + e.getMessage());
    ...
    public byte[] generateLabel(long shipmentId) {
        ...
        try {
            ...
            if (acroForm != null) {
                ...
                field.setValue(String.valueOf(shipmentService.getDeclairedPrice(shipmentId)));
