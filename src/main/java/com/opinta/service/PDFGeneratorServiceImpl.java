...
public class PDFGeneratorServiceImpl implements PDFGeneratorService {
    ...
    private static final String ERROR_WHILE_PARSING = "Error while parsing PDF template: ";
    private static final String ERROR_WHILE_READING = "Error while reading the template file %s";
    ...
    public byte[] generatePostpay(long shipmentId) {
        ...
        try {
            ...
            log.error(ERROR_WHILE_READING, PDF_LABEL_TEMPLATE);
        }
        return data;
    }
    ...
    public byte[] generateLabel(long shipmentId) {
        ...
        try {
            ...
            if (acroForm != null) {
                ...
                float weightFloat = shipmentService.getWeight(shipment) ;
                field.setValue(String.valueOf(weightFloat));
