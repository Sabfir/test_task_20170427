...
public class ParcelServiceImpl implements ParcelService {
    ...
    public Parcel saveEntity(Parcel parcel) {
        log.info("Saving shipment {}", parcel);
    ...
    public ParcelDto save(ParcelDto parcelDto) {
        log.info("Parcel dto {}", parcelDto);
        Parcel parcel = parcelMapper.toEntity(parcelDto);
        log.info("Parcel entity {}", parcel);
        Parcel createdParcel = parcelDao.save(parcel);
        return parcelMapper.toDto(createdParcel);
    }
