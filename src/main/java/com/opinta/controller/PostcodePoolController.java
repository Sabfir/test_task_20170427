...
public class PostcodePoolController {
    private static final String POSTCODE_POOL_ERROR_MESSAGE = "No PostcodePool found for ID %d";
    ...
    public ResponseEntity<?> getPostcodePool(@PathVariable("id") long id) {
        ...
        if (postcodePoolDto == null) {
            return new ResponseEntity<>(format(POSTCODE_POOL_ERROR_MESSAGE, id), NOT_FOUND);
        }
