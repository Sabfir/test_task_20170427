...
public class PostcodePoolController {
    ...
    private static final String POSTCODE_POOL_DOESNT_EXIST = "PostcodePool %d doesn't exist";
    ...
    public ResponseEntity<?> getBarcodeInnerNumbers(@PathVariable long postcodeId) {
        ...
        if (barcodeInnerNumberDtos == null) {
            return new ResponseEntity<>(format(POSTCODE_POOL_DOESNT_EXIST, postcodeId), NOT_FOUND);
        }
