...
public class PostcodePoolController {
    private static final String NO_POSTCODE_POOL_FOUND_FOR_ID = "No PostcodePool found for ID %d";
    private static final String POSTCODE_POOL_D_DOES_NOT_EXIST = "PostcodePool %d doesn't exist";
    private static final String NO_BARCODE_INNER_NUMBER_FOUND_FOR_ID = "No barcodeInnerNumber found for ID %d";
    ...
    public ResponseEntity<?> getPostcodePool(@PathVariable("id") long id) {
        ...
        if (postcodePoolDto == null) {
            return new ResponseEntity<>(format(NO_POSTCODE_POOL_FOUND_FOR_ID, id), HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> getBarcodeInnerNumbers(@PathVariable long postcodeId) {
        ...
        if (barcodeInnerNumberDtos == null) {
            return new ResponseEntity<>(format(POSTCODE_POOL_D_DOES_NOT_EXIST, postcodeId), HttpStatus.NOT_FOUND);
        }
    ...
    public ResponseEntity<?> getBarcodeInnerNumber(@PathVariable("id") long id) {
        ...
        if (barcodeInnerNumberDto == null) {
            return new ResponseEntity<>(format(NO_BARCODE_INNER_NUMBER_FOUND_FOR_ID, id), HttpStatus.NOT_FOUND);
        }
