...
public class PostOfficeController {
    private static final String POST_OFFICE_ERROR_MESSAGE = "No PostOffice found for ID %d";
    ...
    public ResponseEntity<?> getPostOffice(@PathVariable("id") long id) {
        ...
        if (postOfficeDto == null) {
            return new ResponseEntity<>(format(POST_OFFICE_ERROR_MESSAGE, id), NOT_FOUND);
        }
