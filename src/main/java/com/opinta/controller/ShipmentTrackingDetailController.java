...
public class ShipmentTrackingDetailController {
	public static final String NOT_FOUND_MESSAGE = "No ShipmentTrackingDetail found for ID %d";
    private final ShipmentTrackingDetailService shipmentTrackingDetailService;

    @Autowired
    public ShipmentTrackingDetailController(
	...
	public ResponseEntity<?> getShipmentTrackingDetail(@PathVariable("id") long id) {
		ShipmentTrackingDetailDto shipmentTrackingDetailDto = shipmentTrackingDetailService
				.getById(id);
	...
	@PostMapping
    @ResponseStatus(OK)
	public void createShipmentTrackingDetail(
			@RequestBody ShipmentTrackingDetailDto shipmentTrackingDetailDto) {
	...
	public ResponseEntity<?> updateShipmentTrackingDetail(
			...
			@RequestBody ShipmentTrackingDetailDto shipmentTrackingDetailDto) {
		shipmentTrackingDetailDto = shipmentTrackingDetailService.update(id,
