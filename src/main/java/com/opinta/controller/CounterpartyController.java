...
public class CounterpartyController {
    private static final String NO_COUNTERPARTY_ERROR_MESSAGE = "No Counterparty found for ID %d";
    ...
    public ResponseEntity<?> getPostOffice(@PathVariable("id") long id) {
        ...
        if (counterpartyDto == null) {
            return new ResponseEntity<>(format(NO_COUNTERPARTY_ERROR_MESSAGE, id), NOT_FOUND);
        }
    ...
    public ResponseEntity<?> getClientsByCounterpartyId(@PathVariable long counterpartyId) {
        ...
        if (clientDtos == null) {
            return new ResponseEntity<>(format(NO_COUNTERPARTY_ERROR_MESSAGE, counterpartyId), NOT_FOUND);
        }
