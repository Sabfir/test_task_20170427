...
public class CounterpartyController {
    private static final String NO_COUNTERPARTY_ERROR = "No Counterparty found for ID %d";
    ...
    public ResponseEntity<?> getPostOffice(@PathVariable("id") long id) {
        ...
        if (counterpartyDto == null) {
            return new ResponseEntity<>(format(NO_COUNTERPARTY_ERROR, id), NOT_FOUND);
        }
    ...
    public ResponseEntity<?> getClientsByCounterpartyId(@PathVariable long counterpartyId) {
        ...
        if (clientDtos == null) {
            return new ResponseEntity<>(format(NO_COUNTERPARTY_ERROR, counterpartyId), NOT_FOUND);
        }
